  ...
  return (
    <div className="pt-[88px] px-4 md:px-8 pb-12 max-w-7xl mx-auto">
      <div className="flex items-center gap-4">
        <div className="w-16 h-16 rounded-full flex items-center justify-center text-2xl font-bold" style={{ background: `${info?.color}20`, color: info?.color }}>
          {symbol.toUpperCase()}
        </div>
        <div>
          <h1 className="text-3xl md:text-4xl font-bold">{symbol.toUpperCase()} / USD</h1>
      ...
      <div className="mt-8"><PriceChart symbol={`${symbol.toUpperCase()}/USD`} /></div>
    </div>
  );
}
