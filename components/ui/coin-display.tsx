...
export default function CoinDisplay({ 
  ...
  return (
    <div className={`w-full max-w-[400px] mx-auto aspect-square rounded-2xl overflow-hidden bg-gradient-to-b from-[#0a0a1a] to-[#1a1a2e] shadow-2xl shadow-gold/10 border border-white/5 ${className}`}>
      <PremiumCoin3D 
        symbol={symbol} 
        label={label} 
        color={color} 
