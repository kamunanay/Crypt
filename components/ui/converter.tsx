    ...
    <div className="rounded-2xl p-6 bg-white/5 backdrop-blur-xl border border-white/5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div>
          ...
          <select
            ...
            className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-[#f5c842]/50"
          >
            {currencies.map((c) => (
      ...
      <div className="mt-4 text-center">
        {isLoading ? (
          ...
          <>
            <p className="text-2xl font-bold text-[#f5c842]">
